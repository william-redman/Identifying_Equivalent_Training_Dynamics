...
for seed in random_seeds:
    ...
    for init in range(n_inits):
        ...
        if save_flag:
            np.save('/Users/willredman/Documents/AIMdyn/Identifying Equivalent Optimization Algorithms/Transformer grokking/Results/grokking_mod_addition_constrained_alpha_' + str(alpha) + '_seed_' + str(seed) + '_init_' + str(init) + '_weights.npy', weights)
            np.save('/Users/willredman/Documents/AIMdyn/Identifying Equivalent Optimization Algorithms/Transformer grokking/Results/grokking_mod_addition_constrained_alpha_' + str(alpha) + '_seed_' + str(seed) + '_init_' + str(init) + '_train_accuracies.npy', train_accuracies)
            np.save('/Users/willredman/Documents/AIMdyn/Identifying Equivalent Optimization Algorithms/Transformer grokking/Results/grokking_mod_addition_constrained_alpha_' + str(alpha) + '_seed_' + str(seed) + '_init_' + str(init) + '_test_accuracies.npy', test_accuracies)
            np.save('/Users/willredman/Documents/AIMdyn/Identifying Equivalent Optimization Algorithms/Transformer grokking/Results/grokking_mod_addition_constrained_alpha_' + str(alpha) + '_seed_' + str(seed) + '_init_' + str(init) + '_norms.npy', norms)
...
plt.tight_layout()
if plot_save_flag:
    plt.savefig('/Users/willredman/Documents/AIMdyn/Identifying Equivalent Optimization Algorithms/Transformer grokking/Figures/grokking_mod_addition_constrained_alpha_' + str(alpha) + '_seed_' + str(seed) + '_init_' + str(init) + '_training_testing_accuracy.svg', format = 'svg', dpi = 1200)
