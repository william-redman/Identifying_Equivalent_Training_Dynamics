...
random_seeds = np.array([0]) #np.array([16, 17, 22, 23, 31, 33, 34, 40, 41, 42,])
...
for seed in random_seeds:
    ...
    for init in range(n_inits):
        ...
        if save_flag:
            np.save('Experiments/grokking_mod_addition_seed_' + str(seed) + '_init_' + str(init) + '_weights.npy', weights)
            np.save('Experiments/grokking_mod_addition_seed_' + str(seed) + '_init_' + str(init) + '_train_accuracies.npy', train_accuracies)
            np.save('Experiments/grokking_mod_addition_seed_' + str(seed) + '_init_' + str(init) + '_test_accuracies.npy', test_accuracies)
            np.save('Experiments/grokking_mod_addition_seed_' + str(seed) + '_init_' + str(init) + '_norms.npy', norms)
...
plt.tight_layout()
if plot_save_flag:
    plt.savefig('Figures/grokking_mod_addition_seed_' + str(seed) + '_init_' + str(init) + '_training_testing_accuracy.svg', format = 'svg', dpi = 1200)
